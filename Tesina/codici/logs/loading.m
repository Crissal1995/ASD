function output = loading(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MERGESORT = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   MERGESORT = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   MergeSort = importfile('MergeSort.txt', 1, 10);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/11/18 17:05:24
